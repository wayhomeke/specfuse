function renderTechStack(stack) {
    ...
    lines.push(`- Architecture: ${stack.architecture}`, `- Build: \`${stack.commands.build}\``, `- Test: \`${stack.commands.test}\``, `- Lint: \`${stack.commands.lint}\``);
...
function renderCommitConvention() {
...
export function renderGrillReview() {
...
export function composeCLAUDEmd(ctx) {
    const sections = [
        `# Project CLAUDE.md`,
        '',
